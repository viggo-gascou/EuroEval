...
DA = Language(code="da", name="Danish", and_separator="og", or_separator="eller")
DV = Language(code="dv", name="Divehi")
NL = Language(code="nl", name="Dutch", and_separator="en", or_separator="of")
DZ = Language(code="dz", name="Dzongkha")
EN = Language(code="en", name="English", and_separator="and", or_separator="or")
EO = Language(code="eo", name="Esperanto")
ET = Language(code="et", name="Estonian")
EE = Language(code="ee", name="Ewe")
FO = Language(code="fo", name="Faroese", and_separator="og", or_separator="ella")
FJ = Language(code="fj", name="Fijian")
FI = Language(code="fi", name="Finnish")
FR = Language(code="fr", name="French", and_separator="et", or_separator="ou")
...
DE = Language(code="de", name="German", and_separator="und", or_separator="oder")
...
IS = Language(code="is", name="Icelandic", and_separator="og", or_separator="eða")
...
IT = Language(code="it", name="Italian", and_separator="e", or_separator="o")
...
NO = Language(code="no", name="Norwegian", and_separator="og", or_separator="eller")
NB = Language(
    code="nb", name="Norwegian Bokmål", and_separator="og", or_separator="eller"
)
NN = Language(
    code="nn", name="Norwegian Nynorsk", and_separator="og", or_separator="eller"
)
...
ES = Language(code="es", name="Spanish", and_separator="y", or_separator="o")
SU = Language(code="su", name="Sundanese")
SW = Language(code="sw", name="Swahili")
SS = Language(code="ss", name="Swati")
SV = Language(code="sv", name="Swedish", and_separator="och", or_separator="eller")
