...
def get_reading_comprehension_templates() -> TemplateDict:
    ...
    return {
        ...
        DE: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            prompt_prefix="Im Folgenden finden Sie Texte mit den dazugehörigen "
        ...
        EN: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            ...
            "the above text in at most 3 words.\n\nQuestion: {question}",
        ),
        ES: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            ...
            "3 palabras: {label}",
            instruction_prompt="Texto: {text}\n\nResponda la siguiente pregunta sobre "
            "el texto anterior en máximo 3 palabras.\n\nPregunta: {question}",
        ),
        FO: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
        ...
        FR: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            ...
            "le texte ci-dessus en 3 mots maximum.\n\nQuestion: {question}",
        ),
        IS: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            prompt_prefix="Eftirfarandi eru textar með tilheyrandi spurningum og "
            "svörum.",
        ...
        IT: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            prompt_prefix="I testi che seguono sono accompagnati da domande e "
            "risposte.",
        ...
        NL: PromptConfig(
            **asdict(READING_COMPREHENSION_DEFAULTS),
            prompt_prefix="Hieronder volgen teksten met bijbehorende vragen en "
            "antwoorden.",
            prompt_template="Tekst: {text}\nVraag: {question}\nAntwoord in max "
            "3 woorden: {label}",
