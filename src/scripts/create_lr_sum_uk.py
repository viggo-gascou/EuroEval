...
"""Create the Ukrainian summarisation dataset from LR-Sum."""
...
def main() -> None:
    """Create the Ukrainian LR-Sum summarisation mini dataset and upload to HF Hub."""
    dataset_id = "bltlab/lr-sum"

    # Load the full dataset and filter for Ukrainian subset
    dataset = load_dataset(dataset_id, "ukr")
    ...
    # Create dataset ID
    mini_dataset_id = "EuroEval/lr-sum-uk-mini"
